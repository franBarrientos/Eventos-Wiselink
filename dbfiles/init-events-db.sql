...
INSERT INTO `organizers` (`id`, `personal_data_id`) VALUES (1,2),(2,3),(7,8),(8,9),(9,10),(10,11),(34,11),(11,12),(12,13),(33,44);
...
INSERT INTO `personal_data` (`id`, `first_name`, `last_name`) VALUES (1,'Pedro','Lopez'),(2,'Lucass','Gonzales'),(3,'Lautaro','Gimenez'),(8,'Camila','Gomez'),(9,'Julieta','De los Santos'),(10,'Fabian','Barrientos'),(11,'Rocio','Manchamelo'),(12,'Agustin','Gonzales'),(13,'Francisco','Sosa'),(26,'Franco','Barrientos'),(42,'Pedro','Gutierrez'),(44,'Eduardo','Barrientos');
...
INSERT INTO `user_events` (`user_id`, `event_id`) VALUES (1,1),(1,2);
...
INSERT INTO `users` (`id`, `email`, `password`, `personal_data_id`, `role`) VALUES (1,'user@user.com','$2a$10$Ch0PDhF7y5JibOm4eKbGSunXllhg4HgQMeTzM4gRUMdi1zG22Z/06',1,'USER'),(2,'admin@admin.com','$2a$10$Ch0PDhF7y5JibOm4eKbGSunXllhg4HgQMeTzM4gRUMdi1zG22Z/06',26,'ADMIN'),(10,'francobarrientos@gmail.com','$2a$10$DZItmZoryQLa62pJxZ7yAuTrGShbasNvAGRuaXttqZg7k7HccHxkC',42,'USER');
...
-- Dump completed on 2023-12-11 20:52:29
